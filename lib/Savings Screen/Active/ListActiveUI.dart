...
import 'ActiviteHistory.dart';
import 'ListOfActiveClass.dart';

class ListActiveUI extends StatelessWidget {
   ListActiveUI({Key? key}) : super(key: key);

   final List<ClassForActive>_b=[
     ClassForActive(title: "New Car", startPrice: "2,400,000", endPrice: "6,000,000", progressiveNumber: "40"),
     ClassForActive(title: "Laptop", startPrice: "364,000", endPrice: "400,000", progressiveNumber: "91"),
     ClassForActive(title: "Washing Machine", startPrice: "21,000", endPrice: "210,000", progressiveNumber: "10"),
     ClassForActive(title: "Laptop", startPrice: "364,000", endPrice: "400,000", progressiveNumber: "91"),
