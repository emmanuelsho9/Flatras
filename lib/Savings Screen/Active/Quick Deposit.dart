...
class QuickDepositSetting extends StatefulWidget {
   QuickDepositSetting({Key? key}) : super(key: key);

  @override
  State<QuickDepositSetting> createState() => _QuickDepositSettingState();
}

class _QuickDepositSettingState extends State<QuickDepositSetting> {
