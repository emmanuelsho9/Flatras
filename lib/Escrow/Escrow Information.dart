import 'package:flatra/Escrow/seller/seller.dart';
...
class _EscrowInformationState extends State<EscrowInformation> {
  ...
  Widget build(BuildContext context) {
    ...
    var buyerOne = iAmABuyer(radius: 10, Textdata: "I’m a Buyer",
        Sideicon: Icon(Icons.keyboard_arrow_down_outlined,
          color: Color(0xFF000000),

        ), Boxcolor: Color(0xFFF5F5F5),);
    var sellerOne = iAmABuyer(radius: 10, Textdata: "I’m a Seller",
      Sideicon: Icon(Icons.keyboard_arrow_down_outlined),
      color: Color(0xFF000000), Boxcolor: Color(0xFFF5F5F5),);

    var whicone =InkWell(onTap: () {
    ...
    final appBar = AppBar(
      ...
      title: const Text("Escrow Information", style: TextStyle(
          ...
          child: Column(
            children: [
              ...
              Boxcolor: const Color(0xFF7F23A8),
                onTap: () {
                isBuyer==true?Get.to(const BuyerRequirements()):Get.to(SellerRequirements());
                },
              ),
              const Gap(20),
              InkWell(
...
class iAmABuyer extends StatelessWidget {
  iAmABuyer({
    Key? key, 
   required this.Boxcolor, required this.radius, required this.Textdata,
    this.fontWeight,
    this.color,
    this.fontSize,
    this.onTap,
