...
import 'Withdrawal Summary.dart';


class WithdrawActiviteandComplete extends StatelessWidget {
  const WithdrawActiviteandComplete({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          backgroundColor: Colors.white,
          title: const Text("Withdraw", style: TextStyle(
        ...
        body: screenResponisive(scaffold: Padding(
          ...
          child: Column(
            children:  [
              Text(
                " Manually withdraw money from your\n"
                    "assigned wallet",
