...
import 'CoinsCardBuyer.dart';

class buyerListOfShowBottonSheet extends StatelessWidget {
  buyerListOfShowBottonSheet({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            //         return CoinList(
            //             coin: coinDataController.coinDataFilterList[index]);
            //       },
            //     ),
            //   ),
            // )
